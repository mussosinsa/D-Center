...
import org.openflamingo.mapreduce.uima.DocumentFilter;
import org.openflamingo.mapreduce.uima.UIMAConfiguration;
import org.openflamingo.mapreduce.uima.UIMADocument;

/**
 * Utility class used to read the content of a UIMA SequenceFile.
 */
public class CorpusReader extends Configured implements Tool {

    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(UIMAConfiguration.create(), new CorpusReader(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        options.addOption("i", "input", true, "input UIMA corpus");
