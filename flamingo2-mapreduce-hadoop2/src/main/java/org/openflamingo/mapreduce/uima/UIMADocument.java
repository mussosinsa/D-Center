...
import org.openflamingo.mapreduce.uima.util.MimeUtil;
...
/**
 * Implementation of a Document using Hadoop primitives. A UIMADocument
 * consists of a URL, content type, binary content, metadata and @class
 * Annotations.
 */
public class UIMADocument implements Writable {
    ...
    public void setContentType(String contentType) {
        // make sure that the mime type does not contain any charset info
    ...
    /**
     * Serialization of a UIMADocument *
     */
    ...
    /**
     * Deserialization of a UIMADocument *
     */
    public static UIMADocument read(DataInput in) throws IOException {
        UIMADocument doc = new UIMADocument();
        doc.readFields(in);
        return doc;
    }
     ...
     *
     * @param binaryContent whether to include the binary content
     */
     ...
     * Returns a string representation of the document
     *
     * @param showContent     whether to include the binary content
     * @param showAnnotations whether to include the annotations content
     * @param showText        whether to include the text
     * @param showMD          whether to include the metadata
     */
    public String toString(boolean showContent, boolean showAnnotations, boolean showText, boolean showMD) {
