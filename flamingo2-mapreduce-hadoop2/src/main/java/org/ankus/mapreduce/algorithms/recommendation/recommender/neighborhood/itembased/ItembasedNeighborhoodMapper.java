 ...
 * @date : 2013.07.30
 */
public class ItembasedNeighborhoodMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        String myItem = columns[0];
        String neighborhoodItem = columns[1];

        // Set a variable for join
        context.write(new Text(myItem), new Text(neighborhoodItem + "\t" + Constants.SIMILARITY));
    }
