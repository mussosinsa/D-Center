...
//			if(value.variance == 0) value.variance = 1;
    ...
    public static EMClusterInfoMgr[] loadClusterInfoFile(Configuration conf, Path clusterPath, int clusterCnt, String demiliter) throws IOException {
    ...
    public boolean isEqualClusterInfo(EMClusterInfoMgr cluster) {
