...
/**
 * PredictionItemsMapper
 *
 * @author Suhyun Jeon
 * @version 0.0.1
 * @desc User-based Collaborative Filtering recommendation algorithms
 * Arrange candidate users and user's items for join
 * @date : 2013.07.13
 */
public class PredictionItemsMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        context.write(new Text(me + "\t" + item), new Text("1" + "\t" + Constants.CANDIDATE));
    }
