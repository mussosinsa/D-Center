...
public class BooleanSetDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job1 = HadoopUtil.prepareJob(job1, new Path(input), prepareOutputPath, BooleanSetDriver.class,
        ...
        job2 = HadoopUtil.prepareJob(job2, prepareOutputPath, new Path(output), BooleanSetDriver.class,
