...
public class KMeansDriver extends Configured implements Tool {
     ...
     * @parameter conf        configuration identifier for job (non-mr)
    ...
    private void setInitialClusterCenter(Configuration conf, String clusterOutputPath) throws Exception {
        ...
        inputPath = findFile(fs, inputPath);
        ...
        while ((readStr = br.readLine()) != null) {
            ...
            if (index >= clusterCnt) break;
                ...
                int skipCnt = (int) (Math.random() * 10);
    ...
    private Path findFile(FileSystem fs, Path filePath) throws Exception {
    ...
    */
    ...
    /**
     * @return boolean - if job is successfully finished
    ...
    /**
     * @return boolean - if mr job is successfully finished
     * @desc final cluster assign to each data
     * @parameter conf        configuration identifier for job
    ...
    /**
     * @return string array - arguments for normalization job
