...
public class StringSetDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            Usage.printUsage(Constants.ALGORITHM_STRING_DATA_CORRELATION);
            return -1;
        }
        ...
        job1 = HadoopUtil.prepareJob(job1, new Path(input), prepareOutputPath, StringSetDriver.class,
        ...
        job2 = HadoopUtil.prepareJob(job2, prepareOutputPath, new Path(output), StringSetDriver.class,
