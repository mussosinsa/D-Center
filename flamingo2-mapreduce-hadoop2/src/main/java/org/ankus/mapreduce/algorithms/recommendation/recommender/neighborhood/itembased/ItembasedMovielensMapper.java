 ...
 * @date : 2013.07.13
 */
public class ItembasedMovielensMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        context.write(new Text(item), new Text(userID + "\t" + Constants.MOVIELENS + "\t" + rating));
    }
