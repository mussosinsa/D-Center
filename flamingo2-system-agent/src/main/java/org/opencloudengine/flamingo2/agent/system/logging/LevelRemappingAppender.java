...
package org.opencloudengine.flamingo2.agent.system.logging;
...
/**
 * {@link ch.qos.logback.core.Appender} that can remap {@link ch.qos.logback.classic.spi.ILoggingEvent} {@link ch.qos.logback.classic.Level}s as they are
 * written.
 *
 * @author Phillip Webb
...
public class LevelRemappingAppender extends AppenderBase<ILoggingEvent> {
    ...
    /**
     * Decorate an existing {@link ch.qos.logback.classic.spi.ILoggingEvent} changing the level to DEBUG.
     */
