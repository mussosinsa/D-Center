 ...
 */
Ext.define('Flamingo2.view.batch.cron._HourFieldSet', {
            ...
            items: [
                {
                    ...
                    name: 'hour_type',
                    xtype: 'combo',
                    fieldLabel: message.msg('cron.time'),
                    labelAlign: 'right',
                    labelWidth: 50,
                    store: Ext.create('Ext.data.Store', {
                        fields: ['value', 'name', 'desc'],
                        data: [
                            {value: 'ALL', name: message.msg('cron.type_time_all'), desc: ''},
...
Ext.apply(Ext.form.field.VTypes, {
    ...
    cronHourCommaText: message.msg('batch.msg.quartz_cron_express')
});