 ...
 */
/**
 * ViewModel for Flamingo2.view.hawq.browser._TableAlter
 *
 * @author Ha Neul, Kim
 * @since 2.0
 * @see Flamingo2.view.hawq.browser._TableAlter
 */
Ext.define('Flamingo2.view.hawq.browser._TableAlterModel', {
    extend: 'Ext.app.ViewModel',
    alias: 'viewmodel._hawqTableAlterModel',
    ...
    stores: {
        ...
        hawqConstraint: {
            model: 'Flamingo2.model.hawq.Constraint',
            proxy: {
                type: 'ajax',
                url: CONSTANTS.HAWQ.BROWSER.CONSTRAINTS,
                method: 'GET',
                headers: {
                    'Accept': 'application/json'
                },
            ...
            listeners: {
                beforeload: 'hawqConstraintStoreBeforeload'
            }
        }
    }
});