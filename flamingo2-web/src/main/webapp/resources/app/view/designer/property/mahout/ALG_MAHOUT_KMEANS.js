...
Ext.define('Flamingo2.view.designer.property.mahout.ALG_MAHOUT_KMEANS', {
            ...
            items: [
                {
                    xtype: 'displayfield',
                    height: 20,
                    value: '<a href="http://mahout.apache.org/users/clustering/k-means-clustering.html" target="_blank">k-Means clustering</a>'
                },
                {
                    xtype: 'displayfield',
                    height: 20,
    ...
    afterPropertySet: function (props) {
        ...
        if (props.clustering) {
            props.mapreduce.params.push("--clustering");
        }
        ...
        if (props.outlierThreshold) {
            props.mapreduce.params.push("--outlierThreshold", props.outlierThreshold);
        }
