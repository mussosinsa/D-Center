...
Ext.define('Flamingo2.view.designer.property.ankus.ALG_ANKUS_CERTAIN_FACTOR_SUM', {
            ...
            items: [
                {
                    xtype: 'textfield',
                    name: 'indexList',
                    fieldLabel: message.msg('workflow.stat.param.targetlist'),
                    tooltip: message.msg('workflow.stat.param.targettooltip'),
                ...
                },
                {
                    ...
                    fieldLabel: message.msg('workflow.stat.param.exceplist'),
                    vtype: 'commaseperatednum',
                    allowBlank: true
                },
                {
                    xtype: 'textfield',
                    name: 'cfsumMax',
                    fieldLabel: message.msg('workflow.stat.param.summax'),
                    allowBlank: true
                },
                {
            ...
            items: [
                {
                    xtype: 'textfield',
                    name: 'jar',
                    fieldLabel: message.msg('workflow.common.mapreduce.jar.title'),
                    value: ANKUS.JAR,
            ...
            items: [
                {
                    xtype: 'displayfield',
                    height: 20,
                    value: '<a href="http://www.openankus.org/display/AN/3.1.3+Certainty+Factor+based+Sum" target="_blank">Certainty Factor based Sum</a>'
                }
            ]
        }
    ],
