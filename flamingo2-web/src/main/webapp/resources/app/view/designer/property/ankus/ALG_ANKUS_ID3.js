...
Ext.define('Flamingo2.view.designer.property.ankus.ALG_ANKUS_ID3', {
            ...
            items: [
                {
                    xtype: 'textfield',
                    name: 'indexList',
                    fieldLabel: message.msg('workflow.common.index.target.label'),
                    tooltip: message.msg('workflow.dm.id3Class.tab.parameter.index.target.tip'),
                ...
                },
                {
                    xtype: 'textfield',
                    name: 'classIndex',
                    fieldLabel: message.msg('workflow.dm.id3Class.tab.parameter.classIdx.label'),
                    vtype: 'numeric',
                    allowBlank: false
                },
                {
                    xtype: 'textfield',
                    name: 'minLeafData',
                    fieldLabel: message.msg('workflow.dm.id3Class.tab.parameter.minLeafData.label'),
                    value: 2,
                    vtype: 'numeric',
                    allowBlank: false
                },
                {
                    xtype: 'textfield',
                    name: 'purity',
                    fieldLabel: message.msg('workflow.dm.id3Class.tab.parameter.purity.label'),
                    value: 0.75,
                    allowBlank: false
                },
                {
                    xtype: 'radiogroup',
                    fieldLabel: message.msg('workflow.dm.id3Class.tab.parameter.resultGeneration.label'),
                    allowBlank: false,
                    columns: 2,
                    itemId: 'myRadio',
                    items: [
            ...
            items: [
                {
                    xtype: 'displayfield',
                    height: 20,
                    value: '<a href="http://www.openankus.org/display/AN/3.4.1+ID3+Classification" target="_blank">ID3 Classification</a>'
                }
            ]
        }
    ],
