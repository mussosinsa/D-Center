...
Ext.define('Flamingo2.view.designer.property.ankus.ALG_ANKUS_EM', {
            ...
            items: [
                {
                    xtype: 'displayfield',
                    height: 20,
                    value: '<a href="http://www.openankus.org/display/AN/3.5.2+EM+Clustering" target="_blank">EM Clustering</a>'
                }
            ]
        }
    ],
