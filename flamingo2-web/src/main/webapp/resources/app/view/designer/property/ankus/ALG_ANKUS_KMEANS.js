...
Ext.define('Flamingo2.view.designer.property.ankus.ALG_ANKUS_KMEANS', {
            ...
            items: [
                {
                    xtype: 'displayfield',
                    height: 20,
                    value: '<a href="http://www.openankus.org/display/AN/3.5.1+K-Means+Clustering" target="_blank">K-Means Clustering</a>'
                }
            ]
        }
    ],
