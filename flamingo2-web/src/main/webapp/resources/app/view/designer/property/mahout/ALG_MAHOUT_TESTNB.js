...
Ext.define('Flamingo2.view.designer.property.mahout.ALG_MAHOUT_TESTNB', {
    extend: 'Flamingo2.view.designer.property._NODE_ALG',
    alias: 'widget.ALG_MAHOUT_TESTNB',
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'fieldcontainer',
                    fieldLabel: message.msg('workflow.am.testnb.model'),
                    defaults: {
                        hideLabel: true
                    },
                    layout: 'hbox',
                ...
                {
                    xtype: 'fieldcontainer',
                    fieldLabel: message.msg('workflow.am.testnb.testcomplementary'),
                    defaultType: 'checkboxfield',
                    items: [
                        {
                            name: 'testComplementary'
                        }
                    ]
                },
                {
                    xtype: 'fieldcontainer',
                    fieldLabel: message.msg('workflow.am.testnb.runseq'),
                    defaultType: 'checkboxfield',
                    items: [
                        {
                            name: 'runSequential'
                ...
                {
                    xtype: 'fieldcontainer',
                    fieldLabel: message.msg('workflow.am.testnb.labelindex'),
                    defaults: {
                        hideLabel: true
                    },
                    layout: 'hbox',
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    value: 'org.apache.mahout.classifier.naivebayes.test.TestNaiveBayesDriver',
                    disabledCls: 'disabled-plain',
                    readOnly: true
                },
                {
...
//        props.mapreduce.params.push("testnb");
        ...
        if (props.model) {
            props.mapreduce.params.push("--model", props.model);
        }

        if (props.testComplementary) {
            props.mapreduce.params.push("--testComplementary", props.testComplementary);
        }
