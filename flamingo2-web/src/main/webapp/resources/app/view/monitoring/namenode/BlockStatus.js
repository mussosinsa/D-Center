 ...
 */
Ext.define('Flamingo2.view.monitoring.namenode.BlockStatus', {
    extend: 'Ext.Panel',
    alias: 'widget.blockStatus',
    ...
    initComponent: function () {
        ...
        me.items = {
            ...
            axes: [
                {
                    type: 'numeric',
                    fields: ['corruptReplicaBlocks', 'pendingReplicationBlocks', 'scheduledReplicationBlocks', 'underReplicatedBlocks', 'missingBlocks'],
                    position: 'left',
                    grid: true,
                    titleMargin: 20,
            ...
            series: [
                {
                    type: 'line',
                    axis: 'left',
                    title: 'Corrupt Replication',
                    xField: 'num',
                    yField: 'corruptReplicaBlocks',
                    style: {
                        opacity: 0.50,
                        minGapWidth: 20,
                ...
                },
                {
                    type: 'line',
                    axis: 'left',
                    title: 'Pending Replication',
                    xField: 'num',
                    yField: 'pendingReplicationBlocks',
                    style: {
                        opacity: 0.50,
                        minGapWidth: 20,
                ...
                },
                {
                    ...
                    xField: 'num',
                    yField: 'scheduledReplicationBlocks',
                    style: {
                        opacity: 0.50,
                        minGapWidth: 20,
                ...
                },
                {
                    ...
                    xField: 'num',
                    yField: 'underReplicatedBlocks',
                    style: {
                        opacity: 0.50,
                        minGapWidth: 20,
                        fill: '#FF8809', // background color
                        stroke: 'black' // line color
                    },
                    marker: {
                        opacity: 0,
                ...
                },
                {
                    ...
                    title: 'Missing',
                    xField: 'num',
                    yField: 'missingBlocks',
                    style: {
                        opacity: 0.50,
                        minGapWidth: 20,
                        fill: '#FFD13E', // background color
                        stroke: 'black' // line color
                    },
                    marker: {
                        opacity: 0,
