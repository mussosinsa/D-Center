 ...
 */
Ext.define('Flamingo2.view.pig.editor.QueryEditor', {
    extend: 'Flamingo2.view.pig.editor.EditorPanel',
    alias: 'widget.pigLatinEditor',

    requires: ['Flamingo2.view.pig.editor.EditorMixin'],
