...
ace.define("ace/mode/sql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (require, exports, module) {
    ...
    var SqlHighlightRules = function () {
        ...
        var keywords = (
        "SELECT|INSERT|UPDATE|DELETE|CREATE|TABLE|FROM|GROUP|BY|ORDER|LIMIT|OFFSET|HAVING|AS|" +
        "TYPE|LEFT|RIGHT|JOIN|ON|OUTER|DESC|ASC|UNION|LINES|TERMINATED|ROW|DELIMITED|FIELDS|FORMAT|PARTITIONED|OVERWRITE|PARTITION|LOAD|DATA|LOCAL|INPATH|EXTERNAL|COMMENT|STORED|TEXTFILE|SEQUENCEFILE|LOCATION|SERDE|RCFILE|SORT|CLUSTERED|KEYS|COLLECTION|ITEMS|SORTED|SKEWED|TRUNCATE|SET"
        );

        var operators = (
            "WHEN|ELSE|END|CASE|AND|OR|WHERE"
        );
        ...
        var defaultDatTypes = (
            "TINYINT|SMALLINT|INT|BIGINT|FLOAT|DOUBLE|DECIMAL|TIMESTAMP|DATE|STRING|VARCHAR|CHAR|BOOLEAN|BINARY"
        );
        ...
        var keywordMapper = this.createKeywordMapper({
            ...
            "storage.type": defaultDatTypes,
            "keyword.other": complexDataTypes,
...
ace.define("ace/mode/hive", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sql_highlight_rules", "ace/range"], function (require, exports, module) {
    "use strict";
