 ...
 *       &lt;sequence>
 *         &lt;element name="query" type="{http://www.flamingo2.com}queryType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "queriesType", namespace = "http://www.flamingo2.com", propOrder = {
        "query"
})
public class QueriesType {

    @XmlElement(namespace = "http://www.flamingo2.com", required = true)
