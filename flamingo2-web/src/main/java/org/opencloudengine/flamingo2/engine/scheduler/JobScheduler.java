...
public interface JobScheduler {
     ...
     * @return Job Key
     */
    JobKey updateJob(String jobName, String jobGroupName, String cronExpression, Map<String, Object> dataMap) throws ServiceException;
     ...
     * @return Job Key
     */
    JobKey updateJob(String jobKey, String jobGroupName, String jobName, String cronExpression) throws ServiceException;
    ...
    /**
     * 등록되어 있는 Job 목록을 조회한다.
     *
     * @return Job 목록
     * @throws ServiceException Job 목록을 조회할 수 없는 경우
     */
    List<Map> getJobs() throws ServiceException;
