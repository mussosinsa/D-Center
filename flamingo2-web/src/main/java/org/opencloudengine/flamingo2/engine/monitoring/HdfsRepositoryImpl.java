...
@Repository
public class HdfsRepositoryImpl extends DefaultSqlSessionDaoSupport implements HdfsRepository {
    ...
    @Autowired
    public HdfsRepositoryImpl(SqlSessionTemplate sqlSessionTemplate) {
        super.setSqlSessionTemplate(sqlSessionTemplate);
    }

    @Override
    public List selectNamenodeMetrics(Map params) {
