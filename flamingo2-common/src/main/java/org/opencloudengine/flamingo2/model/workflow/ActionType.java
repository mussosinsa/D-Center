 ...
 *           &lt;element ref="{http://www.openflamingo.org/schema/workflow}sqoop" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
    ...
    extends NodeType
{
    ...
    /**
     * Gets the value of the sqoop property.
     *
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sqoop property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSqoop().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<Sqoop> getSqoop() {
        if (sqoop == null) {
            sqoop = new ArrayList<Sqoop>();
        }
        return sqoop;
    }
