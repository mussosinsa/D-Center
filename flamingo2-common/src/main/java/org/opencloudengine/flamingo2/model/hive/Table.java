 ...
 */
package org.opencloudengine.flamingo2.model.hive;
...
public class Table extends ExtJSTreeNode {
    ...
    public Table(String databaseName, String tableName, String location, List<Column> columns, boolean isPartitioned) {
        this.databaseName = databaseName;
        this.tableName = tableName;
        this.location = location;
        this.columns = columns;
