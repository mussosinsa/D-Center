...
public class PropertyPlaceholderConfigurerResolver implements PropertyPlaceholderHelper.PlaceholderResolver {
    ...
    private PropertyPlaceholder propertyPlaceholder = new PropertyPlaceholder();
    ...
    public String resolvePlaceholder(String placeholderName) {
        return propertyPlaceholder.resolvePlaceholder(placeholderName, props, PropertyPlaceholder.SYSTEM_PROPERTIES_MODE_FALLBACK);
    }
}