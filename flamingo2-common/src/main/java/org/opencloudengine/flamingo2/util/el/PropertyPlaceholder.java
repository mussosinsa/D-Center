...
public class PropertyPlaceholder extends PlaceholderConfigurerSupport {
    ...
    private static final Constants constants = new Constants(PropertyPlaceholder.class);
     ...
     * @see System#getenv(String)
     */
    public String resolveSystemProperty(String key) {
        try {
    ...
    private class PropertyPlaceholderConfigurerResolver implements PropertyPlaceholderHelper.PlaceholderResolver {
        ...
        public String resolvePlaceholder(String placeholderName) {
            return PropertyPlaceholder.this.resolvePlaceholder(placeholderName, props, systemPropertiesMode);
        }
    }
}