...
import org.opencloudengine.flamingo2.collector.repository.CLDBService;
 ...
 * @version 2.0
 */
public class CLDBUsageJob extends RemoteInvocation {

    /**
     * SLF4J Logging
     */
    private Logger logger = LoggerFactory.getLogger(CLDBUsageJob.class);

    @Override
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        logger.info("CLDB 사용량 정보 수집을 시작합니다.");
        ...
        CLDBService cldbService = applicationContext.getBean(CLDBService.class);
        ...
        for (SystemConfig config : values) {
            ...
            try {
                ...
                cldbService.collect(config.getId(), config.getName(), namenodeInfo);
            } catch (Exception e) {
                logger.warn("CLDB 사용량 정보를 수집할 수 없습니다.", e);
            }
        }
    }
